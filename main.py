...
# train_matrix, valid_matrix, test_matrix = processing_data(train_data, valid_data, test_data)
# Step 2: Process the training, validation and test data to get TF-IDF vectors
print("[INFO] Processing training data...")
train_matrix = process_data_combine_text(train_data, train_data)
...
valid_matrix = process_data_combine_text(train_data, valid_data)  # Fixed this from train_data to valid_data
...
test_matrix = process_data_combine_text(train_data, test_data)
